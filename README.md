...
LAZYSPECKIT_REF=v0.8.3 bash -c "$(curl -fsSL https://raw.githubusercontent.com/Hacklone/lazy-spec-kit/v0.8.3/install.sh)"

# Self-update to a specific version
LAZYSPECKIT_REF=v0.8.3 lazyspeckit self-update
```
